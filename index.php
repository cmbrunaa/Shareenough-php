                ...
                <div class="conteudobannerdiv">
                    <h2>
                     ...
                     <p>
                        ...
                        Nossa plataforma conecta pessoas e empresas a ONGs que estão fazendo a diferença em nossa comunidade. Juntos, podemos oferecer apoio a quem mais precisa.
                     </p>
                     <a class="btn" href="./cadastro-usuario.php">
                             Cadastre-se
                    </a> 
                    <a class="btn" href="./login.php">
                       Faça  Login
                     </a>
                    <p>É ong e deseja se juntar a nós?</p>
                    <a class="btn" href="./cadastro-ong.php">
                        Cadastre-se
                    </a>
                </div>
            </div>      
